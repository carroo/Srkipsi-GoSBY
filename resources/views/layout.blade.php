        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <a href="/" class="flex items-center space-x-3 shrink-0 group">
                    <div class="relative">
                        <div class="absolute inset-0 bg-linear-to-r from-blue-600 to-indigo-600 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-300"></div>
                    ...
                    <div>
                        <h1 class="text-2xl font-bold bg-linear-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">GoSBY</h1>
            ...
            <!-- Mobile Navigation -->
            <div id="mobile-menu" class="hidden md:hidden pb-4 space-y-2 border-t border-gray-100">
                ...
                <div class="pt-2 border-t border-gray-100 space-y-2">
                    <button class="w-full px-4 py-2.5 text-gray-700 font-medium hover:bg-gray-100 rounded-lg transition duration-300 text-center">
                        Masuk
                    </button>
                    <a href="/app" class="block w-full bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold py-2.5 text-center hover:shadow-lg transition duration-300">
                        Mulai Sekarang
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="text-sm text-gray-400 space-y-2">
                        <li><a href="mailto:info@wisatasurabaya.com" class="hover:text-white transition">info@wisatasurabaya.com</a></li>
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="text-gray-400 hover:text-white transition">
                            ...
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20v-7.21H5.5V9.25h2.79V7.07c0-2.77 1.69-4.28 4.16-4.28 1.18 0 2.2.09 2.5.13v2.9h-1.72c-1.35 0-1.61.64-1.61 1.58v2.07h3.21l-4.18 3.54V20H8.29z"></path></svg>
                        </a>
                        <a href="#" class="text-gray-400 hover:text-white transition">
            ...
            <div class="border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
                <p>&copy; 2025 Wisata Surabaya. All rights reserved. | <a href="#" class="hover:text-white transition">Kebijakan Privasi</a> | <a href="#" class="hover:text-white transition">Syarat Layanan</a></p>
            </div>
        </div>
    </footer>
